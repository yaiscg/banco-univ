  ...
  return (
    <div className="Becas">
      ...
      <div className='bg-white w-full py-8 lg:px-16'>
        ...
        <h1 className='text-primary text-2xl font-Montserrat text-center px-6'> Comprometidos con la educación y el futuro social.</h1>
      ...
      <div className='grid md:grid-cols-2 gap-8 place-items-center py-6 px-12 font-Montserrat bg-secondary items-center justify-center'>
        ...
        <div className='text-justify text-xl'>
            <div className="font-bold sm:text-[1.8rem] text-[1.8rem] mb-5 text-primary">
