  ...
  return (
    <div className="Cuentas">
      ...
      <div className='w-full bg-primary text-center py-4'>
        <h1 className='text-white font-Montserrat text-4xl'>Cuenta Estudiantil</h1>
      </div>

      <div className='bg-white w-full py-8 lg:px-16'>
        <h2 className='text-4xl font-Montserrat py-2 px-8 font-bold text-primary'>¿Qué es?</h2>
        <p className="py-4 px-8 text-xl font-Montserrat text-justify">Es un instrumento financiero con el que se pueden realizar los movimientos de depósito y retiro en efectivo.
        Con este tipo de cuenta tendrás la posibilidad de realizar transacciones bancarias como transferencias, retiros por el cajero automático, depósito de efectivo, además de la opción de cobrar tu beca, realizar el pago de la matricula, entre otros.</p>
      </div>

      <div className='container lg:pt-5 bg-blue-50'>
        <div className='text-center'>
          <h2 className='text-primary font-[800] text-[2.4rem] mb-5 py-4 font-Montserrat'>Beneficios</h2>
        </div>

        <div className='flex flex-col justify-center sm:py-4 text-center'>
          <div className='w-full py-3 px-2 sm:max-w-xl sm:mx-auto sm:px-0'>
            <div className='relative text-gray-700 antialiased text-sm'>

              {/* linea vertical*/}

              <div className='hidden absolute w-1 sm:block bg-blue-300 h-full left-1/2 transform -translate-x-1/2'></div>
                  ...
                  <div className='flex justify-start w-full mx-auto items-center'>
                    <div className='w-full sm:w-1/2 sm:pr-8'>
                      <div data-aos="fade-right" data-aos-duration="1200"
                            className='bg-blue-200 p-4 rounded shadow group hover:bg-primary cursor-pointer ease-in duration-150'>
                  ...
                  <div className='flex items-center flex-col sm:flex-row'>
                    <div className='flex justify-end w-full mx-auto items-center'>
                      <div className='w-full sm:w-1/2 sm:pl-8'>
                        <div data-aos="fade-left" data-aos-duration="1300" className='bg-blue-200 p-4 rounded shadow group hover:bg-primary cursor-pointer ease-in duration-150'>
              ...
              <div className='mt-6 sm:mt-0 sm:mb-12'>
                <div className='flex items-center flex-col sm:flex-row'>
                  <div className='flex justify-start w-full mx-auto items-center'>
                    <div className='w-full sm:w-1/2 sm:pr-8'>
                      <div data-aos="fade-right" data-aos-duration="1400" className='bg-blue-200 p-4 rounded shadow group hover:bg-primary cursor-pointer ease-in duration-150'>
              ...
              <div className='mt-6 sm:mt-0 sm:mb-12'>
                  <div className='flex items-center flex-col sm:flex-row'>
                    <div className='flex justify-end w-full mx-auto items-center'>
                      <div className='w-full sm:w-1/2 sm:pl-8'>
                        <div data-aos="fade-left" data-aos-duration="1500" className='bg-blue-200 p-4 rounded shadow group hover:bg-primary cursor-pointer ease-in duration-150'>
              ...
              <div className='mt-6 sm:mt-0 sm:mb-12'>
                <div className='flex items-center flex-col sm:flex-row'>
                  <div className='flex justify-start w-full mx-auto items-center'>
                    <div className='w-full sm:w-1/2 sm:pr-8'>
                      <div data-aos="fade-right" data-aos-duration="1500" className='bg-blue-200 p-4 rounded shadow group hover:bg-primary cursor-pointer ease-in duration-150'>
