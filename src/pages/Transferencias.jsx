        ...
        <div className='max-w-[1240px] mx-auto'>
          <div className='grid md:grid-cols-3 gap-1 px-2 text-center'>
            ...
            <div className='w-full flex flex-col p-2 my-2 rounded-lg'>
              ...
              <h2 className='text-xl font-Montserrat text-primary text-center py-2'>Transferencia inmediata</h2>
              <div className='text-center font-light'>
                <p className='py-2 mx-2 mt-2'>El dinero se hace efectivo de manera inmediata, pudiendo disponer de él al segundo.</p>
              </div>
            </div>

            <div className='w-full flex flex-col p-2 my-2 rounded-lg'>
              <img className='w-40 px-2 py-6 my-2 m-auto' src={comision} alt="/" />
              <h2 className='text-xl font-Montserrat text-primary text-center py-2'>Sin comisión</h2>
              <div className='text-center font-light'>
                <p className='py-2 mx-2 mt-2'>Realiza trasnferencias sin costo adicional a terceros pertenecientes al Banco Universitario.</p>
              </div>
            </div>

            <div className='w-full flex flex-col p-2 my-2 rounded-lg'>
              <img className='w-40 px-2 py-6 my-2 m-auto' src={contacto} alt="/" />
              <h2 className='text-xl font-Montserrat text-primary text-center py-2'>Transfiere a contactos frecuentes</h2>
              <div className='text-center font-light'>
                <p className='py-2 mx-2 mt-2'>Puedes realizar tus transferencias a los contactos de siempre sin añadir una y otra vez los datos.</p>
              </div>
            </div>
